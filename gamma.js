...
function CanviarIdioma(IdIdioma){
    ...
    document.getElementById("caracter").placeholder = Idioma.Input;
    document.getElementById("cara").innerHTML = Idioma.Comprovar;
    document.getElementById("Pista").innerHTML = Idioma.Pista;
    document.getElementById("Paraulatitol").innerHTML = Idioma.Paraula;
    document.getElementById("videstitol").innerHTML = Idioma.Vides;
    document.getElementById("Lletrestitol").innerHTML = Idioma.Lletres;
